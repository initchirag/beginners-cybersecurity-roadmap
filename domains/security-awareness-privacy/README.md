...
Use password managers, PIA, data inventory, reporting button. Build a disposable, host-only lab with snapshots, synthetic data, least privilege, and explicit authorization. Practice a baseline, introduce one harmless test condition, collect evidence, restore, and verify.

## Project

Create a sanitized privacy-by-design training project: define scope and assumptions, draw the architecture or data flow, implement a control, test it, and publish impact, remediation, verification, and limitations.

## Attacks and threats

Common risks include phishing, impersonation, oversharing, re-identification. Discuss them as scenarios and controls; do not target public systems or publish weaponized procedures.
...
Relevant frameworks: NIST Privacy; ISO 27001/27701; CISA. Use cases include privacy-by-design training, incident exercises, control assurance, and communicating risk to technical and non-technical audiences.

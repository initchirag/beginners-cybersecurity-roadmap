...
Use Event Viewer, Sysmon, journald, auditd, PowerShell. Build a disposable, host-only lab with snapshots, synthetic data, least privilege, and explicit authorization. Practice a baseline, introduce one harmless test condition, collect evidence, restore, and verify.

## Project

Create a sanitized endpoint hardening and triage project: define scope and assumptions, draw the architecture or data flow, implement a control, test it, and publish impact, remediation, verification, and limitations.

## Attacks and threats

Common risks include credential abuse, privilege escalation, persistence, malicious scripts. Discuss them as scenarios and controls; do not target public systems or publish weaponized procedures.
...
Relevant frameworks: CIS Benchmarks; Microsoft Baselines; ATT&CK. Use cases include endpoint hardening and triage, incident exercises, control assurance, and communicating risk to technical and non-technical audiences.

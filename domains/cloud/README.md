...
Use cloud audit logs, Terraform, policy-as-code, ScoutSuite. Build a disposable, host-only lab with snapshots, synthetic data, least privilege, and explicit authorization. Practice a baseline, introduce one harmless test condition, collect evidence, restore, and verify.

## Project

Create a sanitized landing-zone governance project: define scope and assumptions, draw the architecture or data flow, implement a control, test it, and publish impact, remediation, verification, and limitations.

## Attacks and threats

Common risks include stolen tokens, excessive permissions, public storage, cryptomining. Discuss them as scenarios and controls; do not target public systems or publish weaponized procedures.
...
Relevant frameworks: CIS Benchmarks; CSA CCM; ATT&CK Cloud. Use cases include landing-zone governance, incident exercises, control assurance, and communicating risk to technical and non-technical audiences.

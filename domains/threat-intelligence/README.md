...
Use STIX/TAXII, MISP, ATT&CK, YARA. Build a disposable, host-only lab with snapshots, synthetic data, least privilege, and explicit authorization. Practice a baseline, introduce one harmless test condition, collect evidence, restore, and verify.

## Project

Create a sanitized hunting briefs and prioritization project: define scope and assumptions, draw the architecture or data flow, implement a control, test it, and publish impact, remediation, verification, and limitations.

## Attacks and threats

Common risks include campaign infrastructure, phishing, exploited vulnerabilities. Discuss them as scenarios and controls; do not target public systems or publish weaponized procedures.
...
Relevant frameworks: STIX 2.1; TAXII 2.1; FIRST TLP. Use cases include hunting briefs and prioritization, incident exercises, control assurance, and communicating risk to technical and non-technical audiences.
